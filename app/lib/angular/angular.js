 ...
 *
 * <pre>
 * var splitcoin = angular.module('splitcoin', []);
 * splitcoin.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://splitcoin.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://splitcoin.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('splitcoin', []).config(function($sceDelegateProvider) {
 ...
 *        'http://splitcoin.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="splitcoinController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("splitcoinController", function splitcoinController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('splitcoinWithSceDisabledsplitcoin', []).config(function($sceProvider) {
