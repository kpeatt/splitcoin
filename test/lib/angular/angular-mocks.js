 ...
 *
 * <pre>
 *   splitcoinDev = angular.module('splitcoinDev', ['splitcoin', 'ngMockE2E']);
 *   splitcoinDev.run(function($httpBackend) {
...
(window.jasmine || window.mocha) && (function(window) {
   ...
   * <pre>
   *
   *   angular.module('splitcoinlicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('splitcoin', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('splitcoinlicationModule'));
   *
   *
